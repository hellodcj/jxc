			...
			<div class="widget-main">
				...
				<form class="form-horizontal" id="addvendor" action="/system/vendor_saveOrupdate" method="post" role="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" name="name" id="name" placeholder="供应商名 必填 " class="col-xs-10 col-sm-12" value="${vendor.name}"/>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" name="address" id="address" placeholder="地址 " class="col-xs-10 col-sm-12" value="${vendor.address}"/>
						</div>
					</div>
				
					<input hidden="hidden" name="id" value="${vendor.id }"></input>
					<div class="space-4"></div>
