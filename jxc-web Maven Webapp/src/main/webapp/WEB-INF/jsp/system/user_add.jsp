...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
	...
	<div class="widget-box">
		<div class="widget-header header-color-pink">
			<h5><i class="icon-pencil"></i>添加用户</h5>
			...
			<div class="widget-main">
				...
				<form class="form-horizontal" id="addUser" action="/system/user_saveOrupdate" method="post" role="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" name="username" id="username" placeholder="用户名 必填 " class="col-xs-10 col-sm-12" />
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" name="nickname" id="nickname" placeholder="姓名" class="col-xs-10 col-sm-12" />
						</div>
					</div>
