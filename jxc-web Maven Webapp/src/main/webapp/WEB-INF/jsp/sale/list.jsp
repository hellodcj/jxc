...
<div class="widget-box">
	<div class="widget-header header-color-pink">
		<h5><i class="icon-table"></i>销售记录</h5>
	</div>
				...
				<tbody>
					<c:forEach items="${pol}" var="po" varStatus="pageStatus">
						...
						<tr>
							...
							<td class='center' rowspan="${len+1}" style="margin:auto;">${po.custom.name}</td>
...
function listByMonth(){
	var url = "/sale/listByMonth";
	var month = $('#slt-date-month').val(); // 入库并跳转到销售列表
	trans2(url, '系统管理-销售记录', 'month='+month); 
}
</script>