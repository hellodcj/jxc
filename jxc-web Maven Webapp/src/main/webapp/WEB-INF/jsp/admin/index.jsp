...
<link rel="stylesheet"
	href="${root}/resources/css/bootstrap-datetimepicker.min.css" />
<link rel="stylesheet" href="${root}/resources/css/jquery.gritter.css" />
<link rel="stylesheet"
	href="${root}/resources/css/jquery-ui-1.10.3.custom.min.css" />
<link rel="stylesheet"
	href="${root}/resources/css/bootstrap-select.min.css" />
<style type="text/css">
.self-icon-animated-bell {
	display: inline-block;
	-moz-animation: demo 500ms 50ms infinite ease;
	-webkit-animation: demo 500ms 50ms infinite ease;
	-o-animation: demo 500ms 50ms infinite ease;
	-ms-animation: demo 500ms 50ms infinite ease;
	animation: demo 500ms 50ms infinite ease;
...
<body>
				...
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						<li><i class="icon-home home-icon"></i> <a
							...
							onclick="javascript:$('#nav01').trigger('click');">首页</a></li>
						<li id="breadcrumb"></li>
					</ul>
				</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<fieldset>
							<div class="control-group">
								...
								<div class="controls">
									<input class="input-xlarge focused" style="height: 28px"
										id="oldpwd" type="password" value=""> <span
										class="help-inline"> *必填项</span>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input class="input-xlarge focused" style="height: 28px"
										id="newpwd" type="password" value=""><span
										class="help-inline"> *必填项</span>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input class="input-xlarge focused" style="height: 28px"
										id="newpwd2" type="password" value=""><span
										class="help-inline"> *必填项</span>
								</div>
							</div>
						</fieldset>
					...
					<div class="modal-footer">
						<button type="button" id="changePwdOk" onclick="headChangePwd();"
							class="btn btn-primary">确定</button>
						<button type="button"
							onclick="javascript:$('#changePwdDiv').modal('hide');"
							data-dismiss="modal" class="btn btn-primary">取消</button>
					</div>
				</div>
			</div>
		</div>
	...
	<script src="${root}/resources/myjs/clear.js"></script>
	<script src="${root}/resources/js/ajaxfileupload.js"></script>
	<script type="text/javascript"
		src="${root}/resources/js/highstock/highstock.js"></script>
	<script src="${root}/resources/myjs/my-StockChart.js"></script>
	<script src="${root}/resources/js/bootstrap-datepicker.min.js"></script>
	<script src="${root}/resources/js/bootstrap-datetimepicker.min.js"></script>
	<script src="${root}/resources/contextmenu/contextmenu.js"></script>

	<script src="${root}/resources/js/typeahead-bs2.min.js"></script>
	<script src="${root}/resources/js/ace-elements.min.js"></script>
	<script src="${root}/resources/js/bootbox.min.js"></script>

	<script src="${root}/resources/js/jquery.validate.min.js"></script>
	<script src="${root}/resources/js/jquery.gritter.min.js"></script>
	<script src="${root}/resources/myjs/my_noty.js"></script>

	<script src="${root}/resources/js/jquery.cookie.js"></script>
	<script src="${root}/resources/js/jquery.fullscreen.js"></script>
	<script src="${root}/resources/Jcrop/js/jquery.Jcrop.min.js"></script>
	<script src="${root}/resources/js/common.js"></script>
	<script src="${root}/resources/js/bootstrap-select.min.js"></script>
	<!-- inline scripts related to this page -->
	<script type="text/javascript"
		src="${root }/resources/js/jquery.form.js"></script>
	<script type="text/javascript" src="${root}/resources/js/print.js"></script>
	<script src="${root}/resources/myjs/myjsUtil.js"></script>

	<script type="text/javascript"
		src="${root}/resources/js/highstock/modules/exporting.js"></script>
	...
	<script type="text/javascript">
		...
		function logtimeToDate(logd) {
			if (logd) {
				logd = logd + '';
				return logd.substr(0, 4) + '-' + logd.substr(4, 2) + '-'
						+ logd.substr(6, 2) + '-' + logd.substr(8, 2) + ':'
						+ logd.substr(10, 2) + ':' + logd.substr(12);
			}
			return '--';
		}
	</script>
